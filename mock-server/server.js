...
const middlewares = jsonServer.defaults(isProduction ? {static: './dist/host/browser'} : {});
...
app.get('*', (req, res, next) => {
  ...
  isProduction ? res.sendFile(path.join(__dirname, '../dist/host/browser/index.html')) : next();
});
