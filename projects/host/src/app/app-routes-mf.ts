...
export const routes: Routes = [
  {
    ...
    // and appends <mf1-v22></mf1-v22>.
    component: MfWrapper,
    data: {
      // mf is used by MfWrapper to load the
      // bundle and create a WC <mf1-v22></mf1-v22>
  ...
  },
  {
    ...
    component: MfWrapper,
    data: {
      mf: { elementId: 'mf2', tag: 'mf2-v22' },
      inputs: { mf: { elementId: 'mf2', tag: 'mf2-v22' } },
    },
  },
  {
    ...
    component: MfWrapper,
    data: {
      mf: { elementId: 'mf3', tag: 'mf3-v22' },
      inputs: { mf: { elementId: 'mf3', tag: 'mf3-v22' } },
    },
  },
  { path: '**', redirectTo: '/mf1' },
];
